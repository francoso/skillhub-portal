...
const navItems = [
  ...
  { href: "/skills", label: "Skill目录", icon: Puzzle },
  { href: "/demo", label: "Demo会", icon: Presentation },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-white border-r border-gray-200 flex flex-col">
      <div className="p-6 border-b border-gray-100">
        ...
        <p className="text-xs text-gray-500 mt-1">联盟Skill生态工作台</p>
      </div>
      ...
      <div className="p-4 border-t border-gray-100">
        ...
        <p className="text-xs text-gray-400">更新: 2026-05-21</p>
      </div>
    </aside>
  );
}
